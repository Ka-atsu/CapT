...
export default function RevealPanel({ step }: Props) {
  return (
    <div className="bg-[#121214] border border-white/5 rounded-2xl p-10">
      <h3 className="text-3xl! font-black! text-white! px-4! py-4! border-b border-neutral-800">
        {step.subtitle}
      </h3>

      <div className={`${markdownStyles.markdownBody} px-4!`}>
        <ReactMarkdown
